...
>
> **Twenty-seven exercises** as of 2026-08-06, on the curriculum's own ids:
...
> `26-sorting`, `27-unions`. Every one accepts its reference solution, rejects a
> plausible wrong one, and has a hint.
>
