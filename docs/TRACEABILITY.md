...
| [REQ-MEM-003](REQUIREMENTS.md#req-mem-003) Address reuse does not transfer identity | [SPEC-MEM-040](MEMORY-MODEL.md#spec-mem-040) … [SPEC-MEM-044](MEMORY-MODEL.md#spec-mem-044) | `free-then-allocate`, and the model pair: one test for the no-evidence case, one for a recorded free ([SPEC-TEST-021](TEST-STRATEGY.md#spec-test-021)) | 2, closed in 6 | **met** (Phase 6a, 2026-08-05) — [R-07](RISKS.md#r-07) |
